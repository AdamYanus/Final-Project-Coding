...
After all of the previous is completed, you can now open the 3 questions seperate notebook files. Go to the run tab and click "restart kernal and run all cells".
This will run all of the code contained in the file.
